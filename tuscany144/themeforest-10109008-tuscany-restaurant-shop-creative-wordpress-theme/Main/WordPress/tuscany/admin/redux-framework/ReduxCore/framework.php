            ...
            public function _options_page_html() {
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved! w_p_l_o_c_k_e_r_._c_o_m', 'redux-framework' ) ) . '</strong></div>';
                    }
