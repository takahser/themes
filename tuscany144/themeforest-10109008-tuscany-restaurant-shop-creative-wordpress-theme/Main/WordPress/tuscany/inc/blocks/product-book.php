...
<!-- Recipes Book -->
<div class="recipes-book-wrapper hidden-xs" data-stellar-horizontal-offset="50" data-stellar-background-ratio="0.5" <?php echo (!empty($bg_img)) ? 'style="background-image:url('.esc_url($bg_img).');"' : ''; ?>>
    <div class="container">
