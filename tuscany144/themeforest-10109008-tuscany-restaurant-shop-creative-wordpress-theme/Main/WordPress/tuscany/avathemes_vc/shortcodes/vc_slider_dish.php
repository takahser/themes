<?php
/**
 *	Slider Dish Block Shortcode for Visual Composer
 */

class WPBakeryShortCode_vc_slider_dish extends  WPBakeryShortCode
{
...
$opts = array(
	"name"		=> __("Slider Dish", 'js_composer'),
	"description" => __('Shortcode for embeding dishes slider block.', 'js_composer'),
	"base"		=> "vc_slider_dish",
	"class"		=> "vc_slider_dish_block",
	"icon"		=> "icon-class",
	"controls"	=> "full",
